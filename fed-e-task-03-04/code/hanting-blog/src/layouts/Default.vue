<template>
  <div>
    <section class="page-header">
      ...
      <h1 class="project-name">Hanting</h1>
      <h2 class="project-tagline">欢迎来到hanting的个人博客。</h2>
      <a href="https://github.com/zhtzhtx" class="btn" target="_blank"
        >GitHub主页</a
      >
      <a
        ...
        <el-row>
          ...
          <el-col :span="4" style="text-align: right">
            ...
            <div style="color: #606266">
              <i class="el-icon-location"></i>&nbsp; 6142743@qq.com
              <br />
            </div>
          </el-col>
          <el-col :span="2" style="text-align: center">
            <img
              v-popover:bigAvatar
              src="https://avatars.githubusercontent.com/u/38995472?v=4"
              style="
                margin-top: 4px;
                margin-right: 10px;
                width: 52px;
            ...
            <el-popover
              ...
              trigger="hover"
            >
              <i class="el-icon-star-on"></i>&emsp;hanting
              <br />
              <i class="el-icon-location"></i>&emsp;NanJing,China
              <br />
              <img
                src="https://avatars.githubusercontent.com/u/38995472?v=4"
...
export default {
  ...
  methods: {
    ...
    selectTopbar(index) {
      ...
      switch (index) {
        case "#githubHome":
          window.open("https://github.com/zhtzhtx");
          break;
        case "#blog":
          if (this.blog) {
            window.open(
